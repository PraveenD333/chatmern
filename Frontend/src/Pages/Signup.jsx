...
import AuthImagePatt from '../Components/AuthimagePatt'
...
const Signup = () => {
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2'>
      ...
      <AuthImagePatt title="Create an Account" subtitle="Join Our Chat Community it Only Takes a Few Seconds to Get Started!..  Secure. Smooth. Beautiful.." />
